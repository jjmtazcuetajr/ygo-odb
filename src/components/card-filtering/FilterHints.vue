  ...
  <TooltipProvider v-if="isHoverDetected" :delay-duration="100" :disable-hoverable-content="true"
    ...
    <TooltipRoot>
      <TooltipTrigger aria-label="Hint"
        class="rounded-md size-[20px] flex items-center justify-center cursor-pointer dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-700">
        <CircleHelp class="size-[14px] sm:size-[16px]" />
      </TooltipTrigger>
      <TooltipPortal>
        <TooltipContent :side-offset="5"
          class="rounded-lg p-2 z-[150] w-[250px] text-sm dark:text-neutral-300 bg-white dark:bg-neutral-900 border border-emerald-600 shadow-lg shadow-neutral-700 dark:shadow-neutral-950 will-change-[transform,opacity] data-[state=delayed-open]:data-[side=top]:animate-slideDownAndFade data-[state=delayed-open]:data-[side=right]:animate-slideLeftAndFade data-[state=delayed-open]:data-[side=left]:animate-slideRightAndFade data-[state=delayed-open]:data-[side=bottom]:animate-slideUpAndFade">
