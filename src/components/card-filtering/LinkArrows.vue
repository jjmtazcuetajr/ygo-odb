...
<template>
  <ToggleGroupRoot type="multiple" class="flex flex-col justify-between size-[100px]">
    <div class="flex justify-between">
      <ToggleGroupItem
        value="Top-Left"
        aria-label="Top-Left Link Arrow"
      ...
      <ToggleGroupItem
        value="Top-Right"
        aria-label="Top-Right Link Arrow"
        :class="toggleGroupItemClasses"
      >
    ...
    <div class="flex justify-between">
      <ToggleGroupItem
        value="Bottom-Left"
        aria-label="Bottom-Left Link Arrow"
        :class="toggleGroupItemClasses"
      >
      ...
      <ToggleGroupItem
        value="Bottom-Right"
        aria-label="Bottom-Right Link Arrow"
        :class="toggleGroupItemClasses"
      >
