  ...
  <DialogRoot>
    ...
    <DialogPortal>
      ...
      <DialogContent :aria-describedby="undefined"
        ...
        <span class="ml-1 mt-3 dark:text-neutral-300" v-else-if="usage === 'clear-all'">
          Are you sure you want to clear the deck builder?
        </span>
        <span class="ml-1 mt-3 dark:text-neutral-300" v-else>
        ...
        <div class="mt-5 mr-1 flex justify-end">
          ...
          <div v-else-if="usage === 'clear-all'" class="flex gap-2">
            <button type="button"
