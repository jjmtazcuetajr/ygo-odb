...
<template>
  <button
    type="button"
    :class="`${buttonVariants[variant]} ${withIcon} ${mobileOnly}`"
    class="cursor-pointer rounded-md px-2 py-1 text-xs text-white transition-[background-color] duration-200 disabled:cursor-not-allowed disabled:opacity-40 sm:text-base"
  >
