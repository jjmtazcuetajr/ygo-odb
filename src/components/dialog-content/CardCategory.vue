...
const toggleButtonStyles = 'cursor-pointer px-2 py-0.5 rounded-full w-[80px] text-xs sm:text-base shadow-sm data-[state=on]:inset-shadow-sm data-[state=on]:shadow-none transition-[color,background-color,box-shadow] duration-300'
...
const darkThemeColors = ' dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:shadow-neutral-500 dark:data-[state=on]:bg-neutral-500 dark:data-[state=on]:inset-shadow-neutral-900'
