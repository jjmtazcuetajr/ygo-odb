        ...
        <DialogModal usage="pagination">
          <template #trigger>
            <button type="button" title="Jump to Page"
              ...
              class="p-1 whitespace-nowrap cursor-pointer rounded-md bg-neutral-300 hover:bg-neutral-400/70 active:bg-neutral-400 dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:active:bg-neutral-500 transition-[background-color,color] duration-200">
