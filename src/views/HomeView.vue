          ...
          <div
            ...
            <div class="flex sm:hidden items-center">
              ...
              <button type="button" aria-label="Hide filters" @click="toggleMobileFilters"
                class="sm:hidden self-start p-1 size-[24px] rounded-full cursor-pointer text-xs sm:text-base dark:text-white bg-gray-200 active:bg-gray-400 dark:bg-zinc-700 dark:active:bg-zinc-500 transition-[background-color,color] duration-200">
                <X :size="16" />
              </button>
            </div>
            <input type="text" placeholder="Enter card name or effect..."
            ...
            <div
              class="grid grid-cols-3 xl:grid-cols-4 gap-3 overflow-y-auto grow shrink basis-0 sm:px-2 mt-6 content-start dark:[color-scheme:dark]">
